    ...
    return (
        <>
            ...
            <button 
                ...
                className='py-2 px-6 mt-6 bg-surface_secondary-light dark:bg-surface_secondary-dark border-transparent text-sm leading-6 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-md transition-colors focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none'>
                Quero enviar outro
            </button>
            </div>
        </>
